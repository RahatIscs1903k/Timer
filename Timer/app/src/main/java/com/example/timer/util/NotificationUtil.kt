...
import com.example.timer.AppConstans
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .setContentIntent(getPndingIntentWithStack(context, MainActivity::class.java))
        ...
        fun showTimerPaused(context: Context) {
            ...
            resumeIntent.action = AppConstans.ACTION_RESUME
        ...
        private fun <T> getPndingIntentWithStack(
            context: Context,
            javaClass: Class<T>
        ): PendingIntent {
